...
- Divided work among group members/assigned roles
  - WireFrame: (Nanditha)
  - Data Planning (Trenton)
  - Team Plan (Everyone)
  - Github Setup Evidence (Derek)
...
- Uploaded profile.html for profile
- Created ER Diagram
- Stylesheet setup for layout and colour palette
- Scripts created for buttons
- Divided work among member
  - Database setup (Trenton)
  - Finish posts and replies board (Derek and Nanditha)
